...
```bash
pip3 install --upgrade git+https://github.com/armandofcom/nautapy.git#v0.2.0
```
...
### Compartir
- [Twitter](https://twitter.com/intent/tweet?url=https%3A%2F%2Fgithub.com%2Farmandof%2Fnautapy%2F&text=Python%20API%20para%20el%20portal%20cautivo%20Nauta%20de%20Cuba%20%2B%20CLI)
